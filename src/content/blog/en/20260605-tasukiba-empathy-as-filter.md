...
"Business SaaS — with a community?" Probably won't resonate with you.
"A place where business utility and community coexist sounds interesting" — that probably will.

Direct continuation of [A-6's "graduation culture" post](/HomePage/en/blog/20260531-tasukiba-graduation-culture/).
...
The best outcome is **for both sides to recognize misalignment early**. Same as [The Courage to Be Disliked](/HomePage/en/blog/20260522-courage-to-be-disliked-teleology/) — the courage not to try to be liked by everyone.
...
| Kind | Description |
|---|---|
| **Acceptable failures** | Thought-through, with care taken to avoid user impact |
| **Unacceptable failures** | Thoughtless failures (these we don't accept) |
...
- [Return autonomy to the user — a UI with no gatekeeper](/HomePage/en/blog/20260604-tasukiba-user-autonomy-ui/) — series part 10, Chapter B close
- [I want to call it graduation, not leaving — why Tasukiba chose Discord](/HomePage/en/blog/20260531-tasukiba-graduation-culture/) — the prior for community design
- [The Courage to Be Disliked, Part 1 — drop the trauma view, live by teleology](/HomePage/en/blog/20260522-courage-to-be-disliked-teleology/) — "courage not to be liked by everyone"

## About Tasukiba

Details on co-developer recruiting are on the [product page](/HomePage/en/product/tasukiba/). Discord invite goes live in stages around release.
