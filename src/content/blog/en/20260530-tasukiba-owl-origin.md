...
<figure style="text-align: center; margin: 2rem auto;">
  ...
  <figcaption style="margin-top: 0.5rem; font-size: 0.9rem; color: var(--color-text-muted);">The Tasuki Owl</figcaption>
</figure>

## Why a mascot at all

After articulating the six axes of differentiation ([last post](/HomePage/en/blog/20260529-tasukiba-six-differentiators/)), the next thing I had to decide was the service's **visual symbol** — its character.
...
It's also a visual inversion of the problem I named in [series part 1](/HomePage/en/blog/20260526-tasukiba-why-i-made-it/): "data the decision-maker's eye never lands on gets treated as if it doesn't exist." The owl is the eye that does land on it.
...
- **Restrained palette** — same root as [the tidy-UI philosophy](/HomePage/en/blog/20260528-tasukiba-simple-ui-roots/)
...
The Tasuki Owl is the device that conveys Tasukiba's temperature **without speaking**. Same root as the "attitude as message" idea in [The Courage to Be Disliked, Part 3 — here and now](/HomePage/en/blog/20260524-courage-to-be-disliked-here-and-now/).
...
- [Six axes that set Tasukiba apart — not from market research, from stubborn preference](/HomePage/en/blog/20260529-tasukiba-six-differentiators/) — series part 4, differentiation
- [Why I obsess over a tidy UI — tracing it back to a high-school notebook](/HomePage/en/blog/20260528-tasukiba-simple-ui-roots/) — same root as the mascot's restrained expression
- [The Courage to Be Disliked, Part 3 — here and now](/HomePage/en/blog/20260524-courage-to-be-disliked-here-and-now/) — attitude as a message that precedes words

## About Tasukiba

The Tasuki Owl appears on the [product page](/HomePage/en/product/tasukiba/) and across the site. You can see how "quiet, watching, not pushy" actually plays out on screen.
