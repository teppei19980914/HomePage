---
title: "Why the Tasuki Owl Won — Scoring 4 Mascot Candidates on 3 Axes"
description: "The Tasuki Owl is the face of Tasukiba, my AI operations secretary. Owl, lighthouse, open book, abstract geometric — four candidates scored on knowledge management, project management, and security. Only the owl hit top marks on all three. Why navy blue won."
date: 2026-06-12
...
<figure style="text-align: center; margin: 2rem auto;">
  <img src="/HomePage/mascot-owl.png" alt="The Tasuki Owl — a navy owl cradling a document with its wings, a shield with a keyhole on its chest, and a circular barrier in the background" width="280" height="280" style="border-radius: 16px; max-width: 100%; height: auto;" />
  <figcaption style="margin-top: 0.5rem; font-size: 0.9rem; color: var(--color-text-muted);">The Tasuki Owl, chosen after a four-candidate comparison</figcaption>
</figure>
...
As [A-5 covered](/HomePage/en/blog/20260530-tasukiba-owl-origin/), the mascot is a device that communicates the service's temperature wordlessly. The decision attitude was set early: **"not because it's cute."**
...
But as [A-5 noted](/HomePage/en/blog/20260530-tasukiba-owl-origin/), the owl carries a **dual symbol — wisdom + protection** across multiple cultures.
...
That duality lets the same icon **hold business-SaaS firmness and community softness simultaneously**. Same reasoning as ["ambiguity used by domain" in A-3](/HomePage/en/blog/20260528-tasukiba-simple-ui-roots/). A single symbol that holds multiple meanings is a strong option.
...
- Consistent with [the tidy-UI philosophy from A-3](/HomePage/en/blog/20260528-tasukiba-simple-ui-roots/)
- Long-term: doesn't fatigue

As [A-5 said](/HomePage/en/blog/20260530-tasukiba-owl-origin/), the Tasuki Owl is "the device that communicates temperature wordlessly." **A character that doesn't talk too much is loved longer.**
...
- [A "cash cow in ten years" — what I want Tasukiba to do in my life](/HomePage/en/blog/20260611-tasukiba-ten-year-vision/) — series part 17, Chapter L close
- [Meet the Tasuki Owl — why Tasukiba's mascot is an owl](/HomePage/en/blog/20260530-tasukiba-owl-origin/) — the three owl symbols
- [Why I obsess over a tidy UI — tracing it back to a high-school notebook](/HomePage/en/blog/20260528-tasukiba-simple-ui-roots/) — same math-of-subtraction as the mascot

## About Tasukiba

The Tasuki Owl carries Tasukiba's temperature. See the [product page](/HomePage/en/product/tasukiba/) and the rest of the site for the owl in context.
