---
title: "Graduation, Not Leaving — Why Tasukiba, an AI Operations Secretary, Chose Discord"
description: "Why I picked Discord over Slack for the community around Tasukiba, an AI operations secretary, and why I call leaving 'graduating.' A lower exit barrier makes a place more comfortable to stay — a design call that runs continuous with the psychological safety project management teams need."
date: 2026-05-31
...
This sounds contradictory. It isn't. It's the same shape as the "anxiety zone" vs. "learning zone" distinction in [Psychological safety isn't reached by "knowing it"](/HomePage/en/blog/20260521-designing-psychological-safety/). **Only a place you believe you can leave can really hold you.**
...
- [Meet the Tasuki Owl — why Tasukiba's mascot is an owl](/HomePage/en/blog/20260530-tasukiba-owl-origin/) — series part 5, mascot
- [Psychological safety isn't reached by "knowing it"](/HomePage/en/blog/20260521-designing-psychological-safety/) — "anxiety zone" vs. "graduation culture"
- [Reteal Organizations — what stops "self-managing teams" in the first place](/HomePage/en/blog/20260518-teal-organization/) — designing communities that run themselves

## About Tasukiba

Public release: June 1, 2026. The [product page](/HomePage/en/product/tasukiba/) covers the service overview and the Discord invite plan.
