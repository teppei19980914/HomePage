---
title: "なぜたすきフクロウの絵を 3 枚に分けたのか — 汎用・チャット・SNS で構図を変えた設計"
description: "AI業務管理秘書たすきばの顔、たすきフクロウは 3 つの元画像を持ちます。汎用（ロゴ / favicon / OG）、意味検索チャット専用、SNS プロフィール用。1 枚で兼ねず構図を分けた理由と、5 つの派生画像で各文脈を最適化するマスコット運用の細部を書きます。"
date: 2026-06-13
