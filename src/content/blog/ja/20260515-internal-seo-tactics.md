...
そこから一歩深掘りして、本記事では **「実装上どんな工夫を仕掛けたか」** を、コード付きで公開します。すべて Astro v6 の静的サイトでの実装ですが、考え方自体は他のフレームワーク（Next.js / Nuxt / Hugo 等）でも応用可能です。
...
3 部作の最終回として、ここまで読んでくださった方は、ぜひご自身のブログでも何か 1 つだけでも試してみてください。1 か月後の数値が変わる体験は、なかなか刺激的です。
