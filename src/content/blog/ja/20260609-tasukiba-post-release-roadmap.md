...
description: "AI業務管理秘書『たすきば』の2026年6月1日リリースで、提案・チャット意味検索・「なぜ?」の3機能はすべて投入済み。Phase 2はStripe本決済とDogfooding反映、Phase 3は多言語対応とAPI公開。プロジェクト管理を強くする今後の計画を、リリース1週間後の温度感で公開します。"
date: 2026-06-09
...
| フェーズ | 期間 | 主要マイルストーン |
|---|---|---|
| **Phase 1（MVP）** | 〜2026-06-01 | 提案エンジン / チャット意味検索 / 「なぜ?」機能（LLM Re-ranking）/ マルチテナント / 課金基盤 |
| **Phase 2** | リリース〜6 ヶ月 | Stripe 本接続 / Dogfooding 反映 / 各機能の精度改善 |
| **Phase 3** | 6 ヶ月〜2 年 | 多言語 / API 公開 |
...
自然言語クエリで、過去資産を引き出す。 [B-2 で書いた "提案"](/HomePage/ja/blog/20260602-tasukiba-suggestion-feature/) の入口を、構造化フォームから対話に広げた機能で、 **すでに稼働しています** 。機能の詳細は [チャット意味検索の解説記事](/HomePage/ja/blog/20260615-tasukiba-chat-semantic-search/) を参照。Phase 2 では、ここから **検索精度のチューニングと UI 改善** に注力します。
...
| フェーズ | 期間 | 内容 |
|---|---|---|
| Phase 1（MVP） | 〜2026-06-01 | 基本機能 + 3 ユニーク機能（提案 / チャット意味検索 / 「なぜ?」） |
| Phase 2 | 〜6 ヶ月 | Stripe 本接続 / Dogfooding / 精度改善 |
| Phase 3 | 〜2 年 | 多言語 / API 公開 |
...
- [提案機能でできること — "気づかなかった過去" を画面に並べる](/HomePage/ja/blog/20260602-tasukiba-suggestion-feature/) — 3 つのユニーク機能の土台になった提案機能
