...
date: 2026-06-16
tags: ["たすきば", "なぜ機能", "LLM Re-ranking", "提案機能", "Pro プラン"]
...
1. [提案機能（リリース済み）](/HomePage/ja/blog/20260602-tasukiba-suggestion-feature/) — 構造化フォームから過去資産が並ぶ
2. [チャット意味検索（リリース済み）](/HomePage/ja/blog/20260615-tasukiba-chat-semantic-search/) — 自然言語で過去資産を引き出す
...
この 3 つで、たすきばのユニーク機能は完成形に到達します。 3 機能ともリリース時点で稼働していますが、 「なぜ？」付きの体験こそが、 [連載第 1 回](/HomePage/ja/blog/20260526-tasukiba-why-i-made-it/) で書いた 「人間がクリエイティブな仕事に時間を使えていない構造」 を、 **本気で解きにいく機能** だと考えています。

技術深堀の補章はここまでです。明日以降は、 Dogfooding から見えてきたものや、 リリース後の運用所感を、 折を見て書いていきます。

## 関連記事

- [たすきばに自然言語で話しかける — チャット意味検索の中身](/HomePage/ja/blog/20260615-tasukiba-chat-semantic-search/) — 連載補章 1 つ目
...
「なぜ？」機能は、 たすきば Knowledge Relay の Pro プランの中核機能で、リリース（2026-06-01）時点で稼働しています。各機能の体験は [プロダクトページ](/HomePage/ja/product/tasukiba/) でご確認いただけます。
