...
description: "『失敗の科学』を読み、失敗を蓄積・分析して次に活かす仕組みの重要性に気づきました。自尊心が学習を阻害するメカニズムと、エンジニアとして失敗を検知・報告・活用する文化をチームでどう作るかを、ミスをした夜の生々しい実体験とあわせて、掘り下げて考えます。"
date: 2026-04-19
...
そして、その仕組みの最大の障壁は、技術的な問題ではなく、**人間の自尊心**です。自分の失敗を認め、共有し、学びに変える。簡単なようでいて、いちばん難しいことかもしれません。
...
- [真面目さの中に、少しだけ陽気さを置いてみる — 『ユーモアは最強の武器である』を読んで](/HomePage/ja/blog/20260726-humor-is-the-secret-weapon/) — 自分の間違いを認める文化とユーモアの関係
