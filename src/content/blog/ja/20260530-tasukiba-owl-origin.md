...
description: "AI業務管理秘書たすきばのマスコットは、フクロウです。ギリシャ神話の知恵、夜目が利く記憶、家を守る守護——3 つの象徴が、ナレッジ管理・プロジェクト管理・セキュリティという 3 軸と過不足なく重なる唯一の選択肢でした。意味検索で関連を差し出す相棒の姿として、温度感を無言で伝える装置を真剣に設計した話と、その表現方針を書きます。"
date: 2026-05-30
