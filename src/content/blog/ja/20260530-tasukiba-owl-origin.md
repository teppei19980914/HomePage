...
description: "たすきばのマスコットは、フクロウです。ギリシャ神話の知恵、夜目が利く記憶、家を守る守護——3 つの象徴がプロダクトの 3 軸（ナレッジ管理・プロジェクト管理・セキュリティ）と過不足なく重なる、唯一の選択肢でした。マスコットを「温度感を無言で伝える装置」として真剣に設計した話と、その表現方針を書きます。"
date: 2026-05-30
