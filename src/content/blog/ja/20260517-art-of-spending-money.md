...
- [『ティール組織 入門』読書ノート — ピラミッド型の限界と、自走できるチームの作り方](/HomePage/ja/blog/20260518-teal-organization/) — 「自立」を組織の視点から考える
- [「絶対にイエス」以外はすべてノー — エッセンシャル思考が教えてくれた「今を生きる」技術](/HomePage/ja/blog/20260508-essentialism-saying-no/) — 何にお金と時間を使うかを見極める
