---
title: "毎日使わない業務ツールは売らない — AI業務管理秘書たすきばを自分のプロジェクト管理に使い倒す理由"
description: "「私自身が最初のユーザ」を最後まで崩さない。AI業務管理秘書たすきばを、リリース直後から自分の本業のプロジェクト管理に全部使い倒します。意味検索で過去の知見を提案するこの相棒を、毎日の現場で鍛える理由と、6 月 15 日のチャレンジを書きます。"
date: 2026-06-10
