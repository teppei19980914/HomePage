---
title: "本日リリース、AI業務管理秘書たすきば — 「毎日1時間が蒸発する構造」を解きにきた6ヶ月"
description: "AI業務管理秘書「たすきば Knowledge Relay」を 2026 年 6 月 1 日に正式リリースしました。過去プロジェクトのナレッジ・リスク・課題・振り返り・メモを意味検索でフクロウが関連提案する、プロジェクト管理とナレッジ管理のためのサービスです。3 プラン × 月額 0 円、技術スタック、コア機能を当日の温度感のままお届けします。"
date: 2026-06-01
