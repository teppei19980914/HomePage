...
私は過去のプロジェクトで **退行テスト工数を 90% 削減** した経験があります。本記事ではそのときの考え方を **選別・自動化・運用の 3 層** に分けて整理します。
...
- [マネージャの仕事は「答え」ではなく「問い」だった](/HomePage/ja/blog/20260509-art-of-asking-questions/) — チームに自動化を浸透させる対話術
