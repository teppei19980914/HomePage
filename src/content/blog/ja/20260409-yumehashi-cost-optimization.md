...
そこで、個人開発の Flutter Web アプリ [ユメハシ（YumeHashi）](/HomePage/ja/product/yumehashi/) では、**まだ余裕があるうちに無料枠の寿命を延ばす施策** を v2.1.0 に入れました。月額 0 円の運用は今のところ続いていて、コスト変動要因は Firestore の書き込み回数だけ、DAU 3,000 人くらいまでは無料枠に収まる試算です。
