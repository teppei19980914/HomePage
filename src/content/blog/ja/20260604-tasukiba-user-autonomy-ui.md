---
title: 'ユーザに主導権を返すUI｜AI業務管理秘書たすきばが"ゲートキーパー"を作らない設計'
description: 'プラン変更も解約もダウングレードも運営との往復ゼロで完結する、AI業務管理秘書『たすきば』のUI設計スタンスを書きます。"あなたのデータはあなたのもの"のエクスポート、唯一の例外である自己ロール変更禁止、画面でできることと権限を一致させる原則まで。プロジェクト管理を自分の手に取り戻す思想です。'
date: 2026-06-04
tags: ["たすきば", "AI業務管理秘書", "プロジェクト管理", "UI設計", "ユーザ自律"]
