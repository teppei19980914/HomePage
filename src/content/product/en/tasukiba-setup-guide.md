...
- **Display tenant name**
  The name that will appear across the service — e.g., "Sample Inc.", "Planning Department". Anything recognizable to your team is fine.
- **Organization ID**
  The short alphanumeric "name tag" we mentioned earlier. Example: `my-company`.
...
There are two consent checkboxes at the bottom of the form — please tick both. You can review the documents on [the Tasukiba overview page](/HomePage/en/product/tasukiba-user/).
...
> 1. **Check your spam / junk folder first.** This is by far the most common cause.
> 2. **Wait 1–2 minutes and refresh your inbox.** Mail servers sometimes deliver with a small delay.
> 3. **If you use corporate email**, your IT department may be filtering inbound mail. You may need to ask them.
> 4. If it still doesn't arrive, press the **"Resend email" button** on the success screen (limited to once every 60 seconds).
...
> **⚠️ Please take a moment here**
> Recovery codes are your **lifeline** if you ever forget your password. Please save them using one of the following methods:
>
...
- **Organization ID**
  The ID you chose at sign-up. **It's printed in your email under "[Important] Organization ID".** Example: `my-company`
- **Email**
  The "first administrator email" you entered at sign-up.
- **Password**
  The password you set in Step ②.
...
Once all three fields are filled, press **"Log in"**.
If everything checks out, you'll land on the **project list screen**. — Congratulations, your first login is complete.
...
2. Press "Enable MFA"
3. Scan the QR code shown on screen with an authenticator app (Google Authenticator, Authy, 1Password, etc.)
4. Enter the 6-digit code from the app to activate
...
<summary>"Organization ID is incorrect"</summary>
...
<details class="faq-item">
<summary>"Email is incorrect"</summary>
...
If you've also lost the recovery codes, please reach us via the [contact form](/HomePage/en/contact/) (choose "Inquiry about Tasukiba").

</details>

<details class="faq-item">
<summary>The invitation email never arrived</summary>

1. **Check your spam folder** first.
2. **Wait 1–2 minutes and refresh** your inbox (delivery delays do happen).
3. If you use corporate email, your inbound filters may be blocking it. Please check with your IT contact.
4. If it still doesn't arrive, press the **"Resend email" button** on the sign-up success screen (limited to once every 60 seconds).

</details>

<details class="faq-item">
<summary>I lost track of this page</summary>

- The login screen also links here ("Can't log in? Read this").
- If you still can't get back, please reach us via the [contact form](/HomePage/en/contact/) — the operator personally reads every message.
...
If something on this page didn't resolve your issue, please don't hesitate to reach out:

- [Contact form](/HomePage/en/contact/) — Pick "Inquiry about Tasukiba". **The operator personally reads every message.**
- [Discord community](https://discord.com/invite/EqY82YvxuG) — Chat casually with the developer and other users.
...
- [Tasukiba Knowledge Relay — Service overview](/HomePage/en/product/tasukiba-user/) — Features, pricing, and FAQ
- [Tasukiba — Join the developer team](/HomePage/en/product/tasukiba-dev/) — For those interested in building with us
