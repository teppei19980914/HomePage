...
## 同じ開発者が、いま力を注いでいるプロダクト

ユメハシは現在、新規受付を停止しています。いま私が主力として開発・運用しているのは、**[学習管理アプリ「ミチナリ」](/HomePage/ja/product/michinari/)** です。資格勉強・読書・仕事の計画をAIが日々引き直してくれる、Windows向けの個人開発アプリです。

なお、この間に開発・運用していた [AI業務管理秘書「たすきば」](/HomePage/ja/product/tasukiba/) は運用を終了しました。ソースコードは [GitHub リポジトリ](https://github.com/teppei19980914/BusinessManagementPlatform) にてポートフォリオとして公開を継続しています。
