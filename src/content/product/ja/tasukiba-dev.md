---
title: "たすきば 開発メンバー募集｜AI業務管理秘書を一緒に育てる、互いに育つコミュニティ"
description: "AI業務管理秘書「たすきば」を一緒に育てる開発メンバーを募集中。経験不問・心理的安全性を大切にするコミュニティで、TypeScript・Next.js・PostgreSQL を実践的に学べます。コードはもちろんテスト・ドキュメント・UXレビューも歓迎。本業の傍ら、月1コミット相当〜から参加できます。"
