...
「アサインされたら、まず何をすればいいの？」に、ひとつの **目安** をお答えします。
**これは義務ではありません**。手応えを掴むための「おすすめルート」として読んでください。

最初の1か月は、いきなり大きな機能を作るのではなく、**たすきばを実際に使いながら、サービス全体と開発フローを体に入れる期間**にすることをおすすめします。目安として **週 10 時間ほど（月 40 時間ほど）** を、次の小さなループに使っていただくと、自然と「メンバーになったら何をしていくのか」が見えてきます（忙しい月は、もちろん無理のない範囲で大丈夫です）。

1. **たすきフクロウ（アプリ内 AI チャット）に質問する** — 画面の機能や使い方で「これ何だろう？」と思ったことを、その場で AI に聞いてみる
2. **AI が答えきれなかったことを 1 つ選ぶ** — うまく答えが返ってこなかった話題を、ひとつピックアップする。**これが「直すと価値が生まれる場所」の目印** です
3. **サーバ側のロジックを調べる** — その機能が実際にどう動いているか、コードを読んで確かめる（分からなければ Discussions で気軽に聞いてください）
4. **ドキュメントを最新化し、FAQ・使い方ガイドを増やす** — 調べて分かったことを、ドキュメントや FAQ に書き足す

このループの嬉しいところは、**研修そのものが本物の貢献になる** ことです。あなたが FAQ や使い方ガイドを増やすと、**たすきフクロウ AI の回答精度がそのぶん上がります**。つまり、あなたの学びが、次に入ってくる人やユーザの助けに、そのまま変わっていきます。

困ったとき・相談したいことは、これまでどおり [GitHub Discussions](https://github.com/teppei19980914/BusinessManagementPlatform/discussions) でお声がけください。
