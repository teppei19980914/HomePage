...
## 同じ開発者が作った、もう一つのプロダクト

個人のタスク管理で頭の中が片づいたら、次はチームやプロジェクト単位の「業務とナレッジ」をどう扱うかが課題になります。過去のプロジェクト・ナレッジ・課題・振り返りを覚え、いま知りたい情報を意味検索で自動的に届けるサービスとして **[AI業務管理秘書「たすきば」](/HomePage/ja/product/tasukiba/)** を開発・運用していましたが、現在は運用を終了しています。設計や実装に関心のある方は、ソースコードを公開している [GitHub リポジトリ](https://github.com/teppei19980914/BusinessManagementPlatform) をご覧ください。
