---
title: "たすきば はじめての方向けガイド｜テナント払い出しから初回ログインまで"
description: "たすきばを初めて使う組織の最初の管理者(テナント管理者)向けに、サインアップによるテナント払い出しからパスワードとリカバリーコードの設定、システム管理者としての初回ログインまでを、画面ごとに何を入力すればよいか迷わない順番でご案内する初回セットアップガイドです。"
